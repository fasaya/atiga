...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url() ?>template/css/cafe.css" type="text/css">
    <link rel="stylesheet" href="<?= base_url() ?>template/fonts/font-awesome/css/font-awesome.min.css" type="text/css">
    <link rel="stylesheet" type="<?= base_url() ?>template/text/css" href="fonts/Simple-Line-Icons-Webfont/simple-line-icons.css" media="screen" />
...
<body>
    ...
    <div class="wrapper-boxed">
        <div class="site-wrapper">
                                                    ...
                                                    <ul class="dm-align-2">
                                                        ...
                                                        <li> <a href="#">Menu Styles <span class="sub-arrow dark pull-right"><i class="fa fa-angle-right" aria-hidden="true"></i></span> </a> <span class="arrow"></span>
                                                            <ul>
                                                                ...
                                                                <li> <a href="index-icecream.html">Menu Center</a> </li>
                                                                <li> <a href="onepage-corporate.html">Menu One Page</a> </li>
                                                ...
                                                <li class="mega-menu"> <a href="header-style3.html">Portfolio</a> <span class="arrow"></span>
                                                    <ul>
                                                        <li> <a href="#" title="home samples">Portfolio columns</a> <span class="arrow"></span>
                                                            <ul>
                                                                <li> <a href="portfolio-full-width.html"><i class="fa fa-angle-right"></i> &nbsp; One Column</a> </li>
                ...
                <div id="rev_slider" class="rev_slider" data-version="5.0">
                    <ul>
                        ...
                        <li data-transition="zoomout">
                            ...
                            <!-- LAYER NR. 1 -->
                            <div class="tp-caption ce-text-1 tp-resizeme rs-parallaxlevel-0" data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']" data-y="['middle','middle','middle','middle']" data-voffset="['-60','-40','-70','-70']" data-fontsize="['80','80','50','30']" data-lineheight="['70','70','70','50']" data-width="none" data-height="none" data-whitespace="nowrap" data-transform_idle="o:1;" data-transform_in="x:[-105%];z:0;rX:0deg;rY:0deg;rZ:-90deg;sX:1;sY:1;skX:0;skY:0;s:2000;e:Power4.easeInOut;" data-transform_out="y:[100%];s:1000;e:Power2.easeInOut;s:1000;e:Power2.easeInOut;" data-mask_in="x:0px;y:0px;s:inherit;e:inherit;" data-mask_out="x:inherit;y:inherit;s:inherit;e:inherit;" data-start="1000" data-splitin="chars" data-splitout="none" data-responsive_offset="on" data-elementdelay="0.1" style="z-index: 5; white-space: nowrap;">Cofee co<span>.</span> </div>

                            <!-- LAYER NR. 2 -->
                            <div class="tp-caption NotGeneric-SubTitle   tp-resizeme rs-parallaxlevel-0" data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']" data-y="['middle','middle','middle','middle']" data-voffset="['-10','20','-20','-20']" data-width="none" data-height="none" data-whitespace="nowrap" data-transform_idle="o:1;" data-transform_in="y:[100%];z:0;rX:0deg;rY:0;rZ:0;sX:1;sY:1;skX:0;skY:0;opacity:0;s:2000;e:Power4.easeInOut;" data-transform_out="y:[100%];s:1000;e:Power2.easeInOut;s:1000;e:Power2.easeInOut;" data-mask_in="x:0px;y:[100%];s:inherit;e:inherit;" data-mask_out="x:inherit;y:inherit;s:inherit;e:inherit;" data-start="1500" data-splitin="none" data-splitout="none" data-responsive_offset="on" style="z-index: 6; white-space: nowrap;">GREAT TAST AT A BEST PRICE </div>

                            <!-- LAYER NR. 5 -->
                            <div class="tp-caption sbut1" data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']" data-y="['top','top','top','top']" data-voffset="['380','400','400','250']" data-speed="800" data-start="2000" data-transform_in="y:bottom;s:1500;e:Power3.easeOut;" data-transform_out="opacity:0;s:3000;e:Power4.easeIn;s:3000;e:Power4.easeIn;" data-endspeed="300" data-captionhidden="off" style="z-index: 6"> <a href="#">Read more</a> </div>
                        </li>
            ...
            <section class="sec-padding section-dark ce-fo-top-padding">
                <div class="container">
                    <div class="row">

                        <div class=" col-md-12 col-sm-12 col-xs-12 col-centered text-center"> <img src="<?= base_url() ?>template/images/logo/f-logo.png" alt="" />
                            <div class="clearfix"></div>
                            <br />
                            <br />
                            <br />
                            <div class="col-md-4 margin-bottom">
                                <div class="iconbox-small left round outline-gray"><i class="fa fa-users" aria-hidden="true"></i></div>
                                <div class="text-box-right">
                                    <h5 class="text-white text-left uppercase">Address</h5>
                                    <p class="text-left">Address: No.28 - 63739 street lorem ipsum City, Country</p>
                                    <p class="text-left">Address: No.28 - 63739 street lorem ipsum City, Country</p>
                                </div>
                            </div>
                            <!--end item-->
                            ...
                            <div class="col-md-4 margin-bottom">
                                <div class="iconbox-small left round outline-gray"><i class="fa fa-coffee" aria-hidden="true"></i></div>
                                <div class="text-box-right">
                                    <h5 class="text-white text-left uppercase">Working Hours</h5>
                                    <p class="text-left">Monday - Friday<br />
                                        10.00 AM - 11.00 PM</p>
                                    <p class="text-left">Monday - Friday<br />
                                        10.00 AM - 11.00 PM</p>
                                </div>
                            ...
                            <div class="col-md-4 margin-bottom">
                                <div class="iconbox-small left round outline-gray"><i class="fa fa-phone" aria-hidden="true"></i></div>
                                <div class="text-box-right">
                                    <h5 class="text-white text-left uppercase">Phone and fax</h5>
                                    <p class="text-left">Address: No.28 - 63739 street lorem ipsum City, Country</p>
                                    <p class="text-left">Phone: + 1 (234) 567 8901</p>
                                </div>
                            </div>
                            <!--end item-->
        ...
        <script type="text/javascript" src="<?= base_url() ?>template/js/cubeportfolio/main3.js"></script>
